...
const config = {
  ...
  inlineSchemaHash:
    'fcf6e51fabfe02a5acfff9e7cd441eda9830b8bd8733433e4643e0fbb67fbb30',
  copyEngine: true,
};
...
if (!fs.existsSync(path.join(__dirname, 'schema.prisma'))) {
  const alternativePaths = ['lib/__generated__/prisma', '__generated__/prisma'];
...
path.join(
  process.cwd(),
  'lib/__generated__/prisma/libquery_engine-debian-openssl-1.1.x.so.node'
);
// file annotations for bundling tools to include these files
