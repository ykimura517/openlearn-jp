          ...
          <table className="w-full border-collapse">
            <tbody>
              <tr className="border-b border-gray-200">
                <th className="py-4 px-6 text-left bg-gray-50 w-1/4">事業者名</th>
              ...
              <tr className="border-b border-gray-200">
                ...
                <td className="py-4 px-6">〒100-0001 東京都千代田区千代田1-1-1</td>
              </tr>
              <tr className="border-b border-gray-200">
              ...
              <tr className="border-b border-gray-200">
                <th className="py-4 px-6 text-left bg-gray-50">メールアドレス</th>
                <td className="py-4 px-6">info@openlearn-jp.example.com</td>
              </tr>
              <tr className="border-b border-gray-200">
                <th className="py-4 px-6 text-left bg-gray-50">URL</th>
                <td className="py-4 px-6">https://www.openlearn-jp.example.com</td>
              </tr>
              <tr className="border-b border-gray-200">
              ...
              <tr className="border-b border-gray-200">
                <th className="py-4 px-6 text-left bg-gray-50">商品等の引渡時期</th>
              ...
              <tr className="border-b border-gray-200">
                <th className="py-4 px-6 text-left bg-gray-50">キャンセル・返品</th>
