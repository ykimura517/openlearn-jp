...
export default function SignUpPage() {
  ...
  // プロフィール情報送信時に、FirebaseのIDトークンと追加情報をバックエンドに送る
  const handleProfileSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (!response.ok) {
        ...
        throw new Error(resData.error || "プロフィール登録に失敗しました。")
      }
      router.push("/")
    } catch (err: any) {
      setError(err.message)
          ...
          <CardContent>
            <form onSubmit={handleProfileSubmit} className="space-y-4">
              ...
              <div className="space-y-2">
                ...
                />
                <p className="text-xs text-gray-500">15文字以内。サービス上で他のユーザーに公開されます。</p>
              </div>
              <div className="space-y-2">
