...
export default function ExamPage({ params }: ExamParams) {
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      <div className="mb-8">
        <Link href="/exams" className="text-orange-500 hover:underline mb-4 inline-block">
        ...
        <div className="flex flex-wrap gap-2 mb-4">
          <span className="bg-orange-100 text-orange-600 px-2 py-1 rounded text-sm">{exam.categoryName}</span>
          <span className="bg-orange-100 text-orange-600 px-2 py-1 rounded text-sm">{exam.level}</span>
        ...
        <CardContent>
          {currentQuestion.type === "multiple-choice" ? (
            ...
            <div>
              ...
              />
              <p className="text-gray-500 text-sm mt-2">100字以内で回答してください。</p>
            </div>
          )}
        </CardContent>
      </Card>
        ...
        <DialogContent className="sm:max-w-md">
          <DialogHeader>
            <DialogTitle className="text-center text-2xl">
              {isPassed ? (
                <span className="text-green-600">合格おめでとうございます！</span>
              ) : (
            ...
            <DialogDescription className="text-center">
              ...
              <p className="text-sm text-gray-600 mb-4">あなたは上位30%のパフォーマンスを達成しました！</p>
            </DialogDescription>
          </DialogHeader>
          <DialogFooter className="flex-col sm:flex-col gap-2">
            ...
            <div className="flex gap-2 w-full">
              ...
              <Link href="/exams" className="flex-1">
                <Button className="w-full bg-orange-500 hover:bg-orange-600 text-white">他の試験を見る</Button>
              </Link>
            </div>
          </DialogFooter>
        </DialogContent>
