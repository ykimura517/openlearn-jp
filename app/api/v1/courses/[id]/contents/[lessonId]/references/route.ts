...
export async function GET(request: NextRequest, { params }: RouteParams) {
        ...
        references: [
          {
            ...
            url: '#',
            description:
              '生成AIの歴史的な発展と主要なマイルストーンについての詳細な解説記事。',
          },
          {
            title: 'OpenAI公式ドキュメント',
            url: 'https://openai.com/docs',
            description:
              'OpenAIの公式ドキュメント。APIの使い方や各モデルの詳細情報が掲載されています。',
          },
          {
            title: '生成AIの種類と応用例',
            url: '#',
            description:
              '様々な種類の生成AIとその実際の応用例についての包括的なガイド。',
          },
        ],
      },
      'lesson-2': {
        references: [
          {
            ...
            description:
              '「Attention Is All You Need」論文。Transformerアーキテクチャの原論文です。',
          },
          {
            title: '大規模言語モデルの仕組み',
            url: '#',
            description:
              'LLMの内部構造と動作原理について、わかりやすく解説した技術記事。',
          },
          {
            title: 'GPTモデルの進化',
            url: '#',
            description:
              'GPT-1からGPT-4までの進化の過程と各モデルの特徴についての解説。',
          },
          {
            title: 'LLMのパラメータとスケーリング法則',
            url: '#',
            description:
              'モデルサイズと性能の関係、スケーリング法則についての研究解説。',
          },
        ],
      },
    },
        ...
        references: [
          {
            ...
            description:
              'OpenAIが提供する公式のプロンプトエンジニアリングガイド。',
          },
          {
            title: '効果的なプロンプト設計のパターン集',
            url: '#',
            description:
              '様々なユースケース別のプロンプトパターンとベストプラクティスをまとめた資料。',
          },
          {
            title: 'プロンプトエンジニアリングの事例研究',
            url: '#',
            description:
              '実際のビジネスシーンでのプロンプトエンジニアリング適用事例と成果の分析。',
          },
        ],
      },
    },
  ...
  const references = mockReferences[courseId]?.[articleId] || defaultReferences;
