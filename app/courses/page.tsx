...
export default function CoursesPage() {
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      ...
      {/* 結果 */}
      <div className="mb-4">
        <p className="text-gray-600">{coursesData.totalCourses} コースが見つかりました</p>
      </div>
        ...
        <>
          ...
          {coursesData.courses.length === 0 && (
            <div className="text-center py-12">
              <p className="text-gray-500 text-lg mb-4">検索条件に一致するコースが見つかりませんでした。</p>
            ...
            <div className="mt-8">
              <Pagination>
                <PaginationContent>
                  ...
                  <PaginationItem>
                    <PaginationNext
                      onClick={() => handlePageChange(Math.min(coursesData.totalPages, currentPage + 1))}
