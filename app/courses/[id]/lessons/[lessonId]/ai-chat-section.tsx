...
export default function AiChatSection({ lessonTitle }: AiChatSectionProps) {
  const { user } = useAuth()
  ...
  const handleSendMessage = async () => {
    ...
    try {
      ...
      const errorMessage: Message = {
        id: `error-${Date.now()}`,
        role: "assistant",
        content: "申し訳ありません。メッセージの送信中にエラーが発生しました。もう一度お試しください。",
        timestamp: new Date(),
      }
      ...
      <Card className="border border-orange-100">
        ...
        <CardContent className="p-6 text-center">
          <div className="flex flex-col items-center justify-center py-8">
            ...
            <h3 className="text-xl font-semibold text-gray-800 mb-2">この機能はログインが必要です</h3>
            <p className="text-gray-600 mb-6">AIアシスタントに質問するには、ログインまたは新規登録が必要です。</p>
