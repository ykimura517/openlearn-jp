...
export default function PracticeQuestions({ questions }: PracticeQuestionsProps) {
  ...
  const checkAnswer = (questionId: number) => {
    ...
    if (question.type === "multiple-choice") {
      ...
      setFeedback({
        ...feedback,
        [questionId]: isCorrect ? "正解です！" : `不正解です。正解は「${question.correctAnswer}」です。`,
      })
      ...
      setFeedback({
        ...feedback,
        [questionId]: "回答を受け付けました。自己評価のために参考解答をご確認ください。",
      })
    }
  }
        ...
        <Card key={question.id} className="overflow-hidden">
          ...
          <CardFooter className="bg-gray-50 border-t border-gray-100">
            <Button
              ...
              disabled={!answers[question.id] || checkedAnswers[question.id] !== undefined}
            >
              回答を確認する
            </Button>
          </CardFooter>
