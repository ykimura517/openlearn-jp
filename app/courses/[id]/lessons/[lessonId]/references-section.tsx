...
export default function ReferencesSection({ courseId, lessonId }: ReferencesSectionProps) {
  ...
  useEffect(() => {
    const fetchReferences = async () => {
      ...
      try {
        const response = await fetch(`/api/v1/courses/${courseId}/lessons/${lessonId}/references`)
        ...
        setError(err instanceof Error ? err.message : "参考リン��の取得中にエラーが発生しました。")
      } finally {
        setIsLoading(false)
      }
    }
